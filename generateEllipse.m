function result = generateEllipse(hull,hullData)
            %
            ...
            % 
            %    Ellipse = a*x^2 + b*x*y + c*y^2 + d*x + e*y + f = -1
            %   
            ...
            % add to struct
            ellipse_t.verLine = new_ver_line;
            ellipse_t.horzLine = new_horz_line;
            ellipse_t.rotatedEllipse = rotated_ellipse;
